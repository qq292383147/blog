...
![img](https://qq292383147.github.io/pictureLibrary/picture/smallRoutine/1.png) 

![img](https://qq292383147.github.io/pictureLibrary/picture/smallRoutine/1_1.png)
...
```html
<!--  url的连接前面必须加上斜杆 “/” -->
<navigator url="/pages/demo/domo">跳转到demo</navigator>
```
...
![img](https://qq292383147.github.io/pictureLibrary/picture/smallRoutine/2.png) 
...
![img](https://qq292383147.github.io/pictureLibrary/picture/smallRoutine/3.png) 
...
eg: 两个页面之间的跳转
创建好的两个页面分别为 `index` 和 `welcome` ，在 `welcome` 有个控件 `button`，通过点击 `button` 可以跳转到 `index`
...
![img](https://qq292383147.github.io/pictureLibrary/picture/smallRoutine/4.png) 

![img](https://qq292383147.github.io/pictureLibrary/picture/smallRoutine/5.png) 
...
![img](https://qq292383147.github.io/pictureLibrary/picture/smallRoutine/6.png) 
